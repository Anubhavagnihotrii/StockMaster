...
public class login {
    ...
    public String login_val(@RequestParam("username") String username, @RequestParam("password") String password,
        ...
        if (username.equalsIgnoreCase(u1) && password.equalsIgnoreCase(p1)
                || username.equalsIgnoreCase(u2) && password.equalsIgnoreCase(p2)
                || username.equals(u3) && password.equalsIgnoreCase(p3)
                || username.equalsIgnoreCase(u4) && password.equalsIgnoreCase(p4)) {
