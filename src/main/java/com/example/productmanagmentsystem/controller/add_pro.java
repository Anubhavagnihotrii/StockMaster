...
public class add_pro {
  ...
  @PostMapping("add-pro")
    public String products_insertion(@RequestParam("product-code") String product_code,@RequestParam("product-name") String product_name,@RequestParam("product-company") String product_company, @RequestParam("product-price")long product_price,@RequestParam("product-quantity")long product_quantity,
  Model model)
  {
